	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Gender->save($this->request->data)) {
				$this->Session->setFlash(__('The gender has been saved.'), 'simple-flash');
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The gender could not be saved. Please, try again.'), 'error-flash');
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Gender->delete()) {
			$this->Session->setFlash(__('The gender has been deleted.'), 'simple-flash');
		} else {
			$this->Session->setFlash(__('The gender could not be deleted. Please, try again.'), 'error-flash');
		}
		return $this->redirect(array('action' => 'index'));
	}
}
