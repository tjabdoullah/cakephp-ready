...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Supprimer'), array('action' => 'delete', $this->Form->value('Role.id')), array(), __('Etes vous sûr de vouloir supprimer # %s?', $this->Form->value('Role.id'))); ?></li>
